function System(systemDiv) {
                ...
                $(systemDiv).on("keydown", ".voiceBar", FocusHandlers.voiceBarKeydown);
                $(systemDiv).on("keydown", ".noteInner", FocusHandlers.noteInnerKeydown)
                $(systemDiv).on("keydown", ".keySignature", KeySignature.keyDown);
                ...
                var newSongHandlers = new function(){
                    var _this = this;
                    this.openNewSongDialog = function(){
                        $("#newSongOverlay").show();
                    }
                ...
                function getSystemObj(includeEls) {
                    var voices = [];
                    var firstBar = $(systemDiv).find(".bar").first();
                ...
                function makeBarsPlayable(startBar, endBar) {
                    var includeEls = true;
                    var sysObj = getSystemObj(includeEls);
